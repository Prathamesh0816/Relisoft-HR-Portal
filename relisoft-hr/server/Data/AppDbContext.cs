...
public class AppDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Employee>().HasData(
            ...
            new Employee { Id = 5, EmployeeCode = "EMP-005", FullName = "Girish Patil", /* ...unchanged... */ RoleId = 8, ManagerCode = "EMP-004", CreatedOn = new DateTime(2026, 1, 1, 0, 0, 0, DateTimeKind.Utc) },
            new Employee { Id = 6, EmployeeCode = "EMP-006", FullName = "Shreerang Joshi", /* ...unchanged... */ RoleId = 5, ManagerCode = "EMP-004", CreatedOn = new DateTime(2026, 1, 1, 0, 0, 0, DateTimeKind.Utc) },
