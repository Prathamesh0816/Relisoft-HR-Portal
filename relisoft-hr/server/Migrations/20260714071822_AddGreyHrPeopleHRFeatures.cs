...
{
    /// <inheritdoc />
    public partial class AddGreyHrPeopleHRFeatures : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmployerCost = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TimesheetEntries_Employees_ApprovedById",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TimesheetPeriods_Employees_ApprovedById",
                        column: x => x.ApprovedById,
                        principalTable: "Employees",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VisitingEmployee = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    ...
                    HasIdCard = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ComplianceRecords_ComplianceRequirements_RequirementId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ContractorEmployees_Contractors_ContractorId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ReimbursedOn = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmployeeId = table.Column<int>(type: "int", nullable: false),
                    CoverNote = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: false),
                    Status = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_InternalJobApplications_Employees_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "Employees",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_InternalJobApplications_InternalJobPostings_JobPostingId",
                        column: x => x.JobPostingId,
                        principalTable: "InternalJobPostings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TrainingRegistrations_Employees_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "Employees",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_TrainingRegistrations_TrainingCourses_CourseId",
                        column: x => x.CourseId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ComplianceRecords_RequirementId",
                table: "ComplianceRecords",
                column: "RequirementId");

            migrationBuilder.CreateIndex(
                name: "IX_ContractorEmployees_ContractorId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InternalJobApplications_EmployeeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InternalJobPostings_CreatedById",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TimesheetEntries_ApprovedById",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TimesheetPeriods_ApprovedById",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TrainingRegistrations_EmployeeId",
                table: "TrainingRegistrations",
                column: "EmployeeId");
