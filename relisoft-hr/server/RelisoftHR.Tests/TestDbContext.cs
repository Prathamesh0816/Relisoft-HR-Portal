...
public static class TestDbContext
{
    ...
    private static void Seed(AppDbContext db)
    {
        ...
        db.Employees.AddRange(
            ...
            new Employee { Id = 3, EmployeeCode = "EMP-003", FullName = "Aradhana Shinde", Email = "aradhana.shinde@relisofttechnologies.com", Department = "Engineering", Designation = "Software Engineer", RoleId = 1, CreatedOn = utc }
        );
